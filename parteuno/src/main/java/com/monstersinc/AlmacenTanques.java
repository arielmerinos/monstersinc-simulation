...
public class AlmacenTanques {
    ...
    public void almacenarTanque(Tanque tanque, String estado) {
        ...
        try {
            if (tanquesDisponibles > 0) {
                ...
                if (tanque.obtenerTipo().equals("Estandar") || tanque.obtenerTipo().equals("Maxitanque")) {
                    tanquesParaNinos++;
                } else {
                    tanquesParaAdultos++;
                }
    ...
    public void liberarTanque(Tanque tanque, String estado) {
        ...
        try {
            tanquesEnUso--;
            tanquesDisponibles++;
            // ¿Como liberamos los tanques?- como actualizamos su estado ? - como los mandamos a distribucion?
        } finally {
            accesoLock.unlock();
        }
    }
